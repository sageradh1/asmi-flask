...
asmidf = pd.read_csv("/home/sagar/workingDir/projectversion1/app/static/database-asmi/uploadedVideosEdited.csv")
# print(asmidf.shape)
# print(len(asmidf))
...
# #Read database and add index column if necessary
# view_history_raw_df = pd.read_csv("app/static/dataset-asmi/userViewHistories.csv")
# # print(asmidf.shape)
# # print(len(asmidf))
# # asmidf['index']=range(1, len(asmidf) + 1)
